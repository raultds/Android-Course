...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setNotificationsButtonState(true, false, false);
    ...
    public void sendNotification() {
        ...
        setNotificationsButtonState(false, true, true);
    }
    ...
    private void setNotificationsButtonState(Boolean isNotifyEnabled, Boolean isUpdateEnabled, Boolean isCancelEnabled) {
